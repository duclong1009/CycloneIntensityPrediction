...
if __name__ == "__main__":
    ...
    elif args.model_type == "prompt_vit6_5_noHRES":
        print("No. fts", n_fts[0])
        cnn_embedder = orca_model.CNNEmbedder(input_channels=n_fts[0], output_dim=768 - args.prompt_dims, kernel_size=10)
        
        prediction_head = orca_model.PredictionHead(n_patchs= (args.image_size // 10) ** 2 +1)
        print(args)
        train_model = orca_model.Prompt_Tuning_Model6_5_noHRES(cnn_embedder, args.body_model_name, prediction_head,args)
    ...
    elif args.model_type == "prompt_vit6_5_nohistorical":
        print("No. fts", n_fts[0])
        cnn_embedder = orca_model.CNNEmbedder(input_channels=n_fts[0], output_dim=768 - args.prompt_dims, kernel_size=10)
        
        prediction_head = orca_model.PredictionHead(n_patchs= (args.image_size // 10) ** 2 +1)
        print(args)
        train_model = orca_model.Prompt_Tuning_Model6_5_no_historical(cnn_embedder, args.body_model_name, prediction_head,args)
    ...
    elif args.model_type == "prompt_vit6_5_noprompt":
        print("No. fts", n_fts[0])
        cnn_embedder = orca_model.CNNEmbedder(input_channels=n_fts[0], output_dim=768, kernel_size=10)
        
        prediction_head = orca_model.PredictionHead(n_patchs= (args.image_size // 10) ** 2 +2)
        print(args)
        train_model = orca_model.Prompt_Tuning_Model6_5_no_prompt(cnn_embedder, args.body_model_name, prediction_head,args)
