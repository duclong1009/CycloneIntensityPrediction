...
python repo/train_cluster.py --model_type mutlioutput_multihead_prompt1  --batch_size 32 --lr 1e-6 --epochs 1000 --patience 10 --data_dir data07/cropped_data --transform_groundtruth  --group_name metnet_model