...
for folder_name in tqdm.tqdm(os.listdir("data/unzipdata3")):
    try:
        file_list = os.listdir(f"data/unzipdata3/{folder_name}/nwp")
    except:
        print(f"data/unzipdata3/{folder_name}/nwp")
    os.makedirs(f"{saved_data_dir}/{folder_name}/nwp/", exist_ok=True)
    pass
    # for file_name in file_list:
    #     # shutil.copy2(f"data/unzipdata3/{folder_name}/nwp/{file_name}", f"{saved_data_dir}/{folder_name}/nwp/{file_name}")
    #     pass
    #     ds = xr.open_dataset(f"data/unzipdata3/{folder_name}/nwp/{file_name}").metpy.parse_cf()
