...
class CycloneDataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        vorticity = nwp_arr['vorticity'][nwp_id]
        wind_speed = nwp_arr['wind_speed'][nwp_id]
        divergence = nwp_arr['divergence'][nwp_id]
...
for mode in ["train","valid","test"]:
    file_path = f"data69/{mode}_index.csv"
    try:
        ...
        folder_dir = f"data69/cropped_data/{mode}"
